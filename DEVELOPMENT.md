...
```bash
git remote add encore encore://retro-personal-portfolio-w3e2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/retro-personal-portfolio-w3e2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/retro-personal-portfolio-w3e2/settings/integrations/github)
